...
# C_01: 倉庫找書
label C_01_algorithm_interaction:
    ...
    menu:
        ...
        "先看中間那格，再決定往左還是往右（二分搜尋）":
            ...
            jump show_efficiency_comparison_result
    ...
    label show_efficiency_comparison_result:
        python hide:
        ...
        if player_algorithm_choice == "binary_search":
            jump show_binary_search_teaching
        elif player_algorithm_choice == "hash_index":
            jump show_hash_index_teaching
        else:
            return

    label show_binary_search_teaching:
        scene bg teaching_card
    ...
    label show_hash_index_teaching:
        scene bg teaching_card
