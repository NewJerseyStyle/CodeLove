...
define achievement_avoided_danger = Achievement(
    name=_("明智的选择"),
    id="avoided_danger",
    description=_("成功避免了不必要的冒险，有时转身离开是最正确的决定"),
    unlocked_image="gui/achievements/avoided_danger.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_met_cee = Achievement(
    name=_("初次相遇"),
    id="met_cee",
    description=_("与 Cee 进行了第一次对话"),
    unlocked_image="gui/achievements/met_cee.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_binary_search = Achievement(
    name=_("聪明的方法"),
    id="learned_binary_search",
    description=_("向 Cee 展示了二分搜寻算法"),
    unlocked_image="gui/achievements/binary_search.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_observer = Achievement(
    name=_("静默观察"),
    id="observer",
    description=_("选择观察而非干预 Cee 的工作"),
    unlocked_image="gui/achievements/observer.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_entered_source_realm = Achievement(
    name=_("踏入源界"),
    id="entered_source_realm",
    description=_("成功进入源界世界"),
    unlocked_image="gui/achievements/entered_source_realm.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_language_master = Achievement(
    name=_("语言大师"),
    id="language_master",
    description=_("完成了所有语言角色的故事线"),
    unlocked_image="gui/achievements/language_master.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_close_friend = Achievement(
    name=_("知心朋友"),
    id="close_friend",
    description=_("与两个语言角色都建立了深厚的关系"),
    unlocked_image="gui/achievements/close_friend.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_bionic_era = Achievement(
    name=_("仿生纪元"),
    id="bionic_era",
    description=_("所有角色都达到了最高好感度"),
    unlocked_image="gui/achievements/bionic_era.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_algorithm_tutor = Achievement(
    name=_("算法导师"),
    id="algorithm_tutor",
    description=_("提供了 10 个或更多算法解决方案"),
    unlocked_image="gui/achievements/algorithm_tutor.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

define achievement_quick_learner = Achievement(
    name=_("快速学习者"),
    id="quick_learner",
    description=_("学会了 5 个或更多编程概念"),
    unlocked_image="gui/achievements/quick_learner.png",
    locked_image="gui/achievements/locked.png",
    stat_max=5
)

define achievement_knowledge_seeker = Achievement(
    name=_("知识探索者"),
    id="knowledge_seeker",
    description=_("学会了 10 个或更多编程概念"),
    unlocked_image="gui/achievements/knowledge_seeker.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

define achievement_consecutive_correct = Achievement(
    name=_("连续正确"),
    id="consecutive_correct",
    description=_("连续做出了 5 次最优选择"),
    unlocked_image="gui/achievements/consecutive_correct.png",
    locked_image="gui/achievements/locked.png",
    stat_max=5
)

define achievement_perfect_decisions = Achievement(
    name=_("完美决策"),
    id="perfect_decisions",
    description=_("连续做出了 10 次最优选择"),
    unlocked_image="gui/achievements/perfect_decisions.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

define achievement_first_steps = Achievement(
    name=_("第一步"),
    id="first_steps",
    description=_("完成了 3 个章节"),
    unlocked_image="gui/achievements/first_steps.png",
    locked_image="gui/achievements/locked.png",
    stat_max=3
)

define achievement_dedicated_player = Achievement(
    name=_("专注玩家"),
    id="dedicated_player",
    description=_("完成了 6 个章节"),
    unlocked_image="gui/achievements/dedicated_player.png",
    locked_image="gui/achievements/locked.png",
    stat_max=6
)

define achievement_explorer = Achievement(
    name=_("探险家"),
    id="explorer",
    description=_("完成了 10 个章节"),
    unlocked_image="gui/achievements/explorer.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

define achievement_hidden_explorer = Achievement(
    name=_("隐藏发现者"),
    id="hidden_explorer",
    description=_("发现了第一个隐藏选项"),
    unlocked_image="gui/achievements/hidden_explorer.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_safe_player = Achievement(
    name=_("安全玩家"),
    id="safe_player",
    description=_("全程没有触发严重或致命后果"),
    unlocked_image="gui/achievements/safe_player.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_efficiency_expert = Achievement(
    name=_("效率专家"),
    id="efficiency_expert",
    description=_("在没有提示的情况下完成了多个章节"),
    unlocked_image="gui/achievements/efficiency_expert.png",
    locked_image="gui/achievements/locked.png",
    stat_max=5
)

define achievement_risk_taker = Achievement(
    name=_("冒险家"),
    id="risk_taker",
    description=_("主动选择了可能导致严重后果的选项"),
    unlocked_image="gui/achievements/risk_taker.png",
    locked_image="gui/achievements/locked.png"
)

define achievement_cee_friend = Achievement(
    name=_("Cee 的伙伴"),
    id="cee_friend",
    description=_("与 Cee 建立了密切的关系"),
    unlocked_image="gui/achievements/cee_friend.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_jawa_colleague = Achievement(
    name=_("Jawa 的同事"),
    id="jawa_colleague",
    description=_("与 Jawa 建立了专业的关系"),
    unlocked_image="gui/achievements/jawa_colleague.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_holiday_enjoyer = Achievement(
    name=_("假日爱好者"),
    id="holiday_enjoyer",
    description=_("参与了 5 次或更多假日活动"),
    unlocked_image="gui/achievements/holiday_enjoyer.png",
    locked_image="gui/achievements/locked.png",
    stat_max=5
)

define achievement_independent = Achievement(
    name=_("独立思考者"),
    id="independent",
    description=_("全程没有使用提示或帮助"),
    unlocked_image="gui/achievements/independent.png",
    locked_image="gui/achievements/locked.png",
    hidden=True
)

define achievement_save_master = Achievement(
    name=_("存档大师"),
    id="save_master",
    description=_("创建了 50 个或更多存档"),
    unlocked_image="gui/achievements/save_master.png",
    locked_image="gui/achievements/locked.png",
    stat_max=50
)

define achievement_load_master = Achievement(
    name=_("读档专家"),
    id="load_master",
    description=_("读取了 30 个或更多存档"),
    unlocked_image="gui/achievements/load_master.png",
    locked_image="gui/achievements/locked.png",
    stat_max=30
)

define achievement_rollback_king = Achievement(
    name=_("回滚之王"),
    id="rollback_king",
    description=_("使用了 20 次或更多回滚"),
    unlocked_image="gui/achievements/rollback_king.png",
    locked_image="gui/achievements/locked.png",
    stat_max=20
)

define achievement_skipper = Achievement(
    name=_("跳读狂"),
    id="skipper",
    description=_("跳过了 10 次或更多文本"),
    unlocked_image="gui/achievements/skipper.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

define achievement_silent_observer = Achievement(
    name=_("沉默观察者"),
    id="silent_observer",
    description=_("观察而不干预的次数达到 10 次"),
    unlocked_image="gui/achievements/silent_observer.png",
    locked_image="gui/achievements/locked.png",
    stat_max=10
)

## End of example achievement declarations
